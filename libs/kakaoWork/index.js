...
exports.getUserList = async () => {
  ...
  const res2 = await kakaoInstance.get(`/v1/users.list?cursor=${cursor}`);
	//console.log(res2.data.users.length);
  const returnUsers = res.data.users.concat(res2.data.users);
  return returnUsers;
};
